...
namespace Equipo_DALC
{
    ...
    public partial class PCEEntities : DbContext
    {
        ...
        public virtual int spEquipoSave(Nullable<int> equipoId, string nombreEquipo, Nullable<int> cantidadJugadores, string nombreDT, string tipoEquipo, string capitanEquipo, Nullable<bool> tieneSub21)
        {
            var equipoIdParameter = equipoId.HasValue ?
                new ObjectParameter("EquipoId", equipoId) :
                new ObjectParameter("EquipoId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spEquipoSave", equipoIdParameter, nombreEquipoParameter, cantidadJugadoresParameter, nombreDTParameter, tipoEquipoParameter, capitanEquipoParameter, tieneSub21Parameter);
        }
